...
class TestWord {
	...
	@Test
	void testPurifyWord() {
		assertEquals("!*^$ù",(String)w5.purifyWord()[0]); //Ne supprime aucun caractère
		assertEquals("KjUYhbJlMpOlOiUHbCdcXwSQaqzfgdSRyHIkoPmLkJHhNbVxdFG",(String)w6.purifyWord()[0]); //Garde tout
		assertEquals("9746531",(String)w7.purifyWord()[0]); //Renvoie les nombres telquel
		assertEquals("l'arm�e",(String)w8.purifyWord()[0]); //Ne supprime pas le '
	}
