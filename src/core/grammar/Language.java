...
public abstract class Language {
	...
	private final Map<WordCorrupted, WordDictionnary> savedCorrections;
	 ...
	 * @return Version corrigée de <code>(WordDictionnary)w</code> OU non corrigée
	 *         <code>(WordCorrupted)w</code>
	 */
	...
	private boolean customContainsKey(WordCorrupted w) {
		for (final Map.Entry<WordCorrupted, WordDictionnary> map : savedCorrections.entrySet()) {
